...
async def show_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "│ • جوایز:\n"
        "│   🔹 ۱۰۰ تا ۱۰۰,۰۰۰ هاپ پوینت\n"
        "│   🔹 💎 ۱ جم (شانس ۰.۰۱% - بسیار نادر!)\n"
        "└─────────────────────\n\n"
        
        "🔹 **سیستم جم:** 💎\n"
        "┌─────────────────────\n"
        "│ • 💎 جم یک ارز بسیار کمیاب است\n"
        "│ • هر ۱ جم = ۱۰,۰۰۰,۰۰۰ هاپ پوینت\n"
        "│ • `تبدیل جم [تعداد]` : تبدیل جم به هاپ پوینت\n"
        "│ • مثال: `تبدیل جم 5`\n"
        "└─────────────────────\n\n"
        
        "🔹 **ماموریت‌های روزانه و هفتگی:** 🎯\n"
        "┌─────────────────────\n"
        "│ • `ماموریت` : مشاهده ماموریت‌ها\n"
        "│ • ماموریت‌های روزانه (هر روز ریست میشوند):\n"
        "│   🔹 هاپ زدن (۱۰ بار)\n"
        "│   🔹 گردونه شانس (۱ بار)\n"
        "│   🔹 فروش محصول (۱ عدد)\n"
        "│   🔹 غذا دادن به سگ (۱ بار)\n"
        "│ • ماموریت‌های هفتگی (هر هفته ریست میشوند):\n"
        "│   🔹 هاپ زدن (۵۰ بار)\n"
        "│   🔹 دعوت دوستان (۱۰ نفر)\n"
        "│   🔹 گردونه شانس (۵ بار)\n"
        "│   🔹 خرید از کارخانه (۵ عدد)\n"
        "│ • پاداش‌ها: جم و هاپ پوینت 🎁\n"
        "└─────────────────────\n\n"
        
        "🔹 **مارکت پیشرفته:** 🛒\n"
        "┌─────────────────────\n"
        "│ • `مارکت` : مشاهده و خرید آیتم‌ها\n"
        "│ • `افزودن آیتم` : ثبت آیتم برای فروش\n"
        "│ • قابلیت‌ها:\n"
        "│   🔹 خرید آیتم از سایر کاربران\n"
        "│   🔹 فروش آیتم به سایر کاربران\n"
        "│   🔹 جستجو در آیتم‌ها\n"
        "│   🔹 مشاهده آیتم‌های خود\n"
        "│ • هر کاربر میتواند آیتم ثبت کند\n"
        "└─────────────────────\n\n"
        ...
        "🔹 **زندان:** 🔒\n"
        "┌─────────────────────\n"
        "│ • `زندان` : مشاهده وضعیت زندان\n"
        "│ • علت‌های زندان:\n"
        "│   🔹 قاچاق گیر افتادن (۱۵ دقیقه)\n"
        "│   🔹 اسپم در هاپ (۶ بار در ۱۰ ثانیه)\n"
        "│ • راه‌های آزادی:\n"
        "│   🔹 پرداخت ۲۰,۰۰۰ هاپ جریمه\n"
        "│   🔹 صبر کردن تا پایان زمان\n"
        "└─────────────────────\n\n"
