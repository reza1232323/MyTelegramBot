...
async def show_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "│ • `لیدربرد` : مشاهده جدول برترین‌ها\n"
        "└─────────────────────\n\n"
        
        "🔹 **سگ و نگهداری:** 🐶\n"
        "┌─────────────────────\n"
        "│ • `خرید سگ` : خرید سگ جدید\n"
        "│ • `سگ` : باز کردن پنل اختصاصی سگ\n"
        ...
        "│ • `سپرده [مقدار]` : واریز پوینت به بانک\n"
        "│ • `برداشت [مقدار]` : برداشت پوینت از بانک\n"
        "└─────────────────────\n\n"
        
        "🔹 **اقتصاد و کسب درآمد:** 💰\n"
        "┌─────────────────────\n"
        "│ • `کارخونه` : خرید محصولات کارخانه\n"
        "│ • `کارخونه من` : مشاهده انبار محصولات\n"
