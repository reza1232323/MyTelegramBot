...
async def buy_stars_direct(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("⭐ ۵۰ استارز - 165 تومن", callback_data="stars_direct_50")],
        [InlineKeyboardButton("⭐ ۱۰۰ استارز - 339 تومن", callback_data="stars_direct_100")],
        [InlineKeyboardButton("⭐ ۱۵۰ استارز - 500 تومن", callback_data="stars_direct_150")],
        [InlineKeyboardButton("⭐ ۲۰۰ استارز - 660 تومن", callback_data="stars_direct_200")],
        [InlineKeyboardButton("⭐ ۵۰۰ استارز - 1,600 تومن", callback_data="stars_direct_500")],
        [InlineKeyboardButton("🔙 بازگشت", callback_data="back_to_menu")],
    ]
...
async def buy_stars_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("📝 ۱ استارز - 4,000 تومن", callback_data="stars_post_1")],
        [InlineKeyboardButton("📝 ۵ استارز - 20,000 تومن", callback_data="stars_post_5")],
        [InlineKeyboardButton("📝 ۱۰ استارز - 40,000 تومن", callback_data="stars_post_10")],
        [InlineKeyboardButton("📝 ۲۵ استارز - 100,000 تومن", callback_data="stars_post_25")],
        [InlineKeyboardButton("📝 ۵۰ استارز - 200,000 تومن", callback_data="stars_post_50")],
        [InlineKeyboardButton("🔙 بازگشت", callback_data="back_to_menu")],
    ]
    ...
    await query.edit_message_text(
        ...
        "💰 قیمت‌ها:\n"
        "• 1 استارز = 4,000 تومن\n"
        "• 5 استارز = 20,000 تومن\n"
        "• 10 استارز = 40,000 تومن\n"
        "• 25 استارز = 100,000 تومن\n"
        "• 50 استارز = 200,000 تومن\n\n"
        "مقدار مورد نظر رو انتخاب کن:",
        reply_markup=InlineKeyboardMarkup(keyboard),
        parse_mode="Markdown"
    )
...
async def buy_gift(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("🎁 ۱۵ استارز - 55 تومن", callback_data="gift_15")],
        [InlineKeyboardButton("🎁 ۲۵ استارز - 85 تومن", callback_data="gift_25")],
        [InlineKeyboardButton("🎁 ۵۰ استارز - 170 تومن", callback_data="gift_50")],
        [InlineKeyboardButton("🎁 ۱۰۰ استارز - 339 تومن", callback_data="gift_100")],
        [InlineKeyboardButton("🔙 بازگشت", callback_data="back_to_menu")],
    ]
